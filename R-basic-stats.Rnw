...
we give Diet and Drug in the formula (we showed this already in Lesson 2)
and we will call them lm1 and lm2
...
Nope. Let us show a simple example. For the sake of the exposition, I will
