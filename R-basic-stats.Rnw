...
\begin{itemize}
\item Even if each (or subsets of) predictor seem strongly associated to the outcome, their p-values could be large, and the sign of the associated reverted, when we fit all of the correlated predictors.
