...
A final one, with another type of data

<<>>=
data(Prestige)
## do ?Prestige

mI <- lm(prestige ~ women * income * education * type, data = Prestige)

## Notice degrees of freedome
Anova(mI)
lm(mI)
## check model!!! This could probably be improved?
plot(mI)
