...
Let us show a simple example. For the sake of the exposition, I will
here simulate the data, so everything is clear and in the open.
...
<<results='hide'>>=
scatterplot(pemax ~ age | sex, smooth = FALSE, 
            spread = FALSE,  by.groups = TRUE, data = cystfibr2)
@ 
...
scatterplot(Metabolic.rate..W. ~ Body.mass..g. | Class, 
            log = "xy", smooth = FALSE, spread = FALSE, 
            by.groups = TRUE, 
            data = anage_a_r)
@ 
