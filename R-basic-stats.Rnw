...
will explore some of the problems\footnote{I thank Alba Concepción, a
...
legend(x = 3, y = 20, legend = c("g1", "g2"), col = c("blue", "red"),
       pch = 1)
...
legend(x = 1.5, y = 2.5, legend = c("g1", "g2"), col = c("blue", "red"),
       pch = 1)
@ 
