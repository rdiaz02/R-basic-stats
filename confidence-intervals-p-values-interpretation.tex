...
\begin{frame}
  ...
  \item Many studies are seriously misinterpreted. For example, this
    has happened, with possibly serious consequences, during the covid pandemic.
  \end{itemize}
\end{frame}
