...
\begin{frame}
  ...
  \begin{description}
  \item[Significance and hypothesis testing] Is there enough evidence to send this person to jail? How likely is it, if she were innocent, that we find the corpse of the victim in her living room? What about her owning a pair of scissors? But \ldots: do you want \(P(O|H)\) or \(P(H|O)\)? (O: observations, H hypothesis)?
%    \vspace*{15pt}
...
{\scriptsize From Miguel Hernán's talk, Causal inference, ``Epidemiological
  Research Methods in the COVID-19 Pandemic'', IAP, 2021-06,14. Also García-Albéniz et
...
\item Wasserstein, R. L., Schirm, A. L., \& Lazar, N. A. (2019). Moving to a World Beyond p < 0.05. \textit{The American Statistician}, 73(sup1), 1-19. \Burl{https://doi.org/10.1080/00031305.2019.1583913}
  ...
  \item García-Albéniz et al. (2021). Systematic review and meta-analysis of
